...
export const buttonVariants = tv({
  variants: {
    variant: {
      primary:
        'rounded-md bg-primary-a text-gray-light py-2 px-3 text-sm font-bold hover:bg-primary-900 border border-primary-a transition-all',
      secondary:
      ...
      outline: 'rounded-md py-2 px-3 border border-gray-light bg-white hover:bg-gray-50 transition-all',
      none: '',
    },
  },
});
